            ...
            <div class="container-fluid">
                <div class="row m-0">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="row justify-content-center pt-80 gy-4 px-3">
                                <h6 class="title mb-3">@lang('Payment Options')</h6>
                                <form action="{{ route('user.deposit.insert') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="method_code">
                                    <input type="hidden" name="currency">
                                    <input type="hidden" name="price_plan_id" value="{{ $price_plan->id }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group country-code">
                                            ...
                                            <input type="number" step="any" name="amount"
                                                class="form-control form--control" value="{{ $price_plan->price }}"
                                                autocomplete="off" required="" id="amount" readonly>
                                        </div>
                                    </div>

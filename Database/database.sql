...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2023 at 12:00 PM
...
CREATE TABLE `admins` (
  ...
  `type` varchar(199) COLLATE utf8mb4_unicode_ci DEFAULT 'admin',
...
INSERT INTO `admins` (`id`, `name`, `email`, `username`, `email_verified_at`, `image`, `password`, `type`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Super Admin', 'admin@example.com', 'admin', NULL, '652e6533358fb1697539379.jpg', '$2y$10$ZOWPSwbB7098UQHq/GZX5uGq43wfuDDjMBNASktSNK55T/4jC/xvy', 'admin', 'qfbFVpp98gbLu1YeCze1rdP9UaXVGAaGjnhhyoYLTWCDDY2l3rB490Wp5Axb', NULL, '2023-10-17 04:42:59');
...
CREATE TABLE `apply_jobs` (
  ...
  `expect_salary` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `categories` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT ' 1 = active, 0 = pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `comments` (
  ...
  `parent_comment_id` bigint(20) DEFAULT NULL COMMENT 'This is comment table. Throw data into this column parent comment id. that means, this table id.',
...
CREATE TABLE `comment_votes` (
  ...
  `unlike` bigint(20) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `deposits` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `price_plan_id` bigint(20) NOT NULL,
  `method_code` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `amount` decimal(28,8) NOT NULL DEFAULT 0.00000000,
  `credit` bigint(255) UNSIGNED DEFAULT NULL,
...
(20, 'manual_deposit', '{\"name\":{\"name\":\"Name\",\"label\":\"name\",\"is_required\":\"required\",\"extensions\":\"\",\"options\":[],\"type\":\"text\"},\"trx\":{\"name\":\"TRX\",\"label\":\"trx\",\"is_required\":\"required\",\"extensions\":\"\",\"options\":[],\"type\":\"text\"}}', '2023-09-20 09:09:22', '2023-09-20 09:09:22'),
(21, 'manual_deposit', '{\"name\":{\"name\":\"Name\",\"label\":\"name\",\"is_required\":\"required\",\"extensions\":\"\",\"options\":[],\"type\":\"text\"},\"trx\":{\"name\":\"Trx\",\"label\":\"trx\",\"is_required\":\"required\",\"extensions\":\"\",\"options\":[],\"type\":\"text\"}}', '2023-09-20 09:12:19', '2023-09-20 09:12:19');
...
(1, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"website\",\"services\",\"forum\",\"discussion\"],\"description\":\"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit\",\"social_title\":\"ProForum\",\"social_description\":\"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit ff\",\"image\":\"652fa71a39c951697621786.jpg\"}', '2020-07-04 23:42:52', '2023-10-18 03:36:48'),
...
CREATE TABLE `general_settings` (
  ...
  `upvote_credit` decimal(60,2) DEFAULT NULL,
  `per_credit_price` bigint(255) DEFAULT NULL,
  `pusher_credential` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `general_settings` (`id`, `site_name`, `cur_text`, `cur_sym`, `credit`, `upvote_credit`, `per_credit_price`, `pusher_credential`, `socialite_credentials`, `email_from`, `email_template`, `sms_body`, `sms_from`, `base_color`, `secondary_color`, `mail_config`, `sms_config`, `global_shortcodes`, `kv`, `ev`, `en`, `sv`, `sn`, `force_ssl`, `maintenance_mode`, `secure_password`, `agree`, `registration`, `active_template`, `system_info`, `created_at`, `updated_at`) VALUES
(1, 'ProForum', 'USD', '$', 5, '0.05', 6, '{\"app_id\":\"1675892\",\"app_key\":\"f8c68dfe4617aea3398e\",\"app_secret\":\"538ee146577768419b16\",\"app_cluster\":\"ap2\",\"useTLS\":\"true\"}', '{\"google\":{\"client_id\":\"423160671071-hkbreo5t6gd8t8077s4264ime1770vqu.apps.googleusercontent.com\",\"client_secret\":\"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\",\"status\":1},\"facebook\":{\"client_id\":\"---------\",\"client_secret\":\"---------\",\"status\":1},\"linkedin\":{\"client_id\":\"772t1ej48e6ezg\",\"client_secret\":\"FbeN3gb6RI6eqisG\",\"status\":0}}', 'info@example.com', '<p>Hi {{fullname}} ({{username}}),&nbsp;</p><p>{{message}}</p>', 'Hi {{fullname}} ({{username}}), \r\n{{message}}', 'ProForum', '1877f2', '060662', '{\"name\":\"smtp\",\"host\":\"smtp.mailtrap.io\",\"port\":\"2525\",\"enc\":\"ssl\",\"username\":\"bcbcc6239f7a0e\",\"password\":\"c5d10803bef9b1\"}', '{\"name\":\"messageBird\",\"clickatell\":{\"api_key\":\"----------------\"},\"infobip\":{\"username\":\"------------8888888\",\"password\":\"-----------------\"},\"message_bird\":{\"api_key\":\"-------------------\"},\"nexmo\":{\"api_key\":\"----------------------\",\"api_secret\":\"----------------------\"},\"sms_broadcast\":{\"username\":\"----------------------\",\"password\":\"-----------------------------\"},\"twilio\":{\"account_sid\":\"-----------------------\",\"auth_token\":\"---------------------------\",\"from\":\"----------------------\"},\"text_magic\":{\"username\":\"-----------------------\",\"apiv2_key\":\"-------------------------------\"},\"custom\":{\"method\":\"get\",\"url\":\"https:\\/\\/hostname\\/demo-api-v1\",\"headers\":{\"name\":[\"api_key\"],\"value\":[\"test_api 555\"]},\"body\":{\"name\":[\"from_number\"],\"value\":[\"5657545757\"]}}}', '{\n    \"site_name\":\"Name of your site\",\n    \"site_currency\":\"Currency of your site\",\n    \"currency_symbol\":\"Symbol of currency\"\n}', 0, 1, 1, 0, 0, 0, 0, 0, 1, 1, 'default', '[]', NULL, '2023-10-18 03:34:13');

-- --------------------------------------------------------

--
-- Table structure for table `hides`
--
...
(1, '2023_10_15_070827_create_post_images_table', 1);
...
CREATE TABLE `posts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL COMMENT 'This field both are admin id and user id',
  `category_id` bigint(20) UNSIGNED NOT NULL DEFAULT 0,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `job` tinyint(4) NOT NULL DEFAULT 0 COMMENT 'if post is job',
  ...
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT '0 = disable, 1 = enable,2 = canceled',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `post_comment_reports`
--
...
CREATE TABLE `post_comment_reports` (
  ...
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'type=post or type=comment',
  `post_report_user` bigint(20) NOT NULL DEFAULT 0,
  `comment_report_user` bigint(20) NOT NULL DEFAULT 0,
...
CREATE TABLE `post_images` (
  ...
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `path` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transactions` (
  ...
  `post_credit` varchar(199) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `credit` decimal(60,2) NOT NULL DEFAULT 0.00,
  ...
  `ts` tinyint(1) NOT NULL DEFAULT 1 COMMENT '0: 2fa off, 1: 2fa on',
  `tv` tinyint(1) NOT NULL DEFAULT 1 COMMENT '0: 2fa unverified, 1: 2fa verified',
  `tsc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `login_by` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ban_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(199) COLLATE utf8mb4_unicode_ci DEFAULT 'user',
  `remember_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user_notifications` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `read_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `click_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `vote_credits`
--
...
--
-- Indexes for table `post_comment_reports`
--
...
--
-- Indexes for table `vote_credits`
--
...
--
-- AUTO_INCREMENT for table `hides`
--
ALTER TABLE `hides`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `post_comment_reports`
--
ALTER TABLE `post_comment_reports`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `vote_credits`
--
ALTER TABLE `vote_credits`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
